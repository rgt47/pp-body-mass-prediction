...
description: "Regression models on the Palmer Penguins dataset reveal how much species identity shapes morphometric relationships. Simpson's Paradox emerges clearly, reversing an apparent correlation once species is accounted for."
...
![Palmer penguins in their Antarctic habitat](media/images/hero.png){.img-fluid width=80% fig-align="center"}
...
- To examine whether adding species as a covariate
  ...
  adds complexity.
- To practice the tidymodels framework for systematic
...
![A clean workspace ready for data exploration.](media/images/ambiance1.png){.img-fluid height=3.5in}
...
![Penguin research in progress](media/images/ambiance2.png){.img-fluid height=3.5in}
...
![Final reflections on the analysis](media/images/ambiance3.png){.img-fluid height=3.5in}
...
6. **Post 55: Predictive Modeling of Penguin Body Mass** (this post)
